...
if (!function_exists('sw_secure_route'))
{
    function sw_secure_route($path)
    {
...
if (!function_exists('sw_array2csv')) {
    function sw_array2csv($array)
    {
        if (count($array) == 0) {
            return null;
        }
...
if (!function_exists('sw_download_headers')) {
    function sw_download_headers($filename)
    {
        // disable caching
        $now = gmdate("D, d M Ysw_ H:i:s");
...
if (!function_exists('sw_sanitize_slug')) {
    function sw_sanitize_slug($slug)
    {
        $slug = explode('-', $slug);
...
if (!function_exists('sw_reset_permalinks')) {
    function sw_reset_permalinks()
    {
        global $wp_rewrite;
...
if (!function_exists('sw_fifty_states')) {
    function sw_fifty_states()
    {
...
if (!function_exists('sw_get_client_ip')) {
...
if (!function_exists('sw_form_control')) {
    function sw_form_control($type, $name, $map, $mode = 'normal', $array = array())
    {
        $string = '';
...
if (!function_exists('sw_image_url')) {
    function image_url($subpath)
    {
        echo sitsw__url() . '/images/'.$subpath;
    }
}

if (!function_exists('sw_get_full_name')) {
    function sw_get_full_name($user_id =null)
    {
        if (is_null($user_id)) {
...
if (!function_exists('sw_array_strain')) {
    function sw_array_strain($data, $keys)
    {
        $ret = array();
