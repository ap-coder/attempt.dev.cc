...
<div class="bootstrap-wrapper">
    <div class="wrap">
        <h2><?php esc_html_e( 'EDIT Software' ); ?></h2>
        <hr>
                ...
                <div class="card" style="max-width: 80%; overflow-x:auto;">
                    <table class="form-table" style="width: 100%;">
                        <tbody>
                            ...
                            <tr>
                                <th>
                                    <label for="filename">Software Version</label>
                                </th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="sdesc" id="sdesc" cols="30" rows="10"><?php if ( is_object( $package ) ) {
                                            echo $package->sdesc;
                                        } ?></textarea>
                                </td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <textarea name="ldesc" id="ldesc" cols="30" rows="10"><?php if ( is_object( $package ) ) {
                                        echo $package->ldesc;
                                    } ?></textarea> -->
                                    <?php
                                        $settings       = array(
                                        ...
                                        <?php
                                            ...
                                            foreach ( $products as $product ): ?>
                                                <li class="list-item d-flex justify-content-between align-items-center" data-product_id="<?php echo $product->ID; ?>" style="<?php echo in_array( $product->ID, $assoc_prods ) ? 'display:none' : '' ?>">
                                                    ...
                                                    <button style="margin-right:10px;" type="button" class="btn-add btn btn-primary float-right">
                                ...
                                <td style="width: 50%; background-color: #f9f9f9; box-shadow: 0px 0px 3px 0px inset #ddd;vertical-align:top">
                                    ...
                                    <ul id="selected-products" class="simple_with_drop list-group" style="max-height: 400px; min-height: 300px; overflow-y: scroll;">
                                        <?php
                                            ...
                                            $products    = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}posts WHERE post_type='avada_portfolio' AND post_status = 'publish'" );
                                            foreach ( $products as $product ):
                                                if ( ! in_array( $product->ID, $assoc_prods ) ) {
                                                    continue;
                                                } ?>
                                                <li class="list-item d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button style="margin-right:10px;" type="button" class="btn-unselect btn btn-danger float-right">
                                    ...
                                    <div id="client-files">
                                        ...
                                        <div class="client-file" data-id="<?php if ( is_object( $file ) ) {  echo $file->id; } ?>">
                                            <div class="flex-row">
                                                ...
                                                <div style="margin-left: auto;">
                                                    ...
                                                    <?php
                                                        if ( is_object( $file ) ) {
                                                            ?>
                                                            <a class="btn download" href="<?php echo swroute( 'download/' . $file->id ); ?>"><i class="fa fa-download"></i></a>
                                                            <?php
                                                        }
                                                    ?>
                                                </div>
                                            ...
                                            <div style="font-size: 0.8em; color: #555; ">
                                                <?php if ( is_object( $file ) ) {
                                                    echo 'Uploaded: ' . date( 'm/d/Y', strtotime( $file->created_at ) );
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: right;">
                                    <a style="cursor: pointer; color: #fff;" class="btn btn-remove delete-doc"> Delete
...
<script>
    jQuery(document).ready(function ($) {
                ...
                $.ajax({
                    ...
                    success: function (d) {
                        if (d.status == 'success') {
                            ...
                            $('.message-box')
                                .html('<div class="alert alert-warning">' + d.message + '</div>')
                        }
                    },
                    complete: function () {
                    }
        ...
        $('.btn.btn-select').on('click', function () {
            ...
            $('#selected-products')
                .append('<li><span class="right btn btn-unselect"><i class="fa fa-minus"></i></span><span class="none">' + label + '</span><input type="hidden" name="products[]" class="product" value="' + product_id + '" /></li>')
        });
