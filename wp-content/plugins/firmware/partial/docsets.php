...
$sql = "SELECT SQL_CALC_FOUND_ROWS *, fw.nicename as nicename
			  FROM {$wpdb->prefix}firmware as fw WHERE 1=1 ";
...
<div class="wrap">
<h1 class="wp-heading-inline">Firmware</h1>

<hr />

<form method="GET" action="<?php echo admin_url(); ?>admin.php?page=firmware-list">
	...
	<p class="search-box">
		...
		<input type="hidden" value="firmware-list" name="page">
	</p>
</form>
		...
		<tbody>
			<?php foreach($results as $key=>$result):?>
				<tr <?php echo $key % 2 == 0 ? 'class="alternate"':''; ?> data-row="<?php echo $result->id;?>">
					...
					<td>[firmware firmware_id="<?php echo $result->id;?>"]</td>
					<td class="column-columnname">
	          <a style="color: #00a0d2;" href="<?php echo site_url( '/wp-admin/admin.php?page=firmware-list&firmware_id='.$result->id.'&detail', $scheme = null )?>">Edit</a>
					</td>
				</tr>
			<?php endforeach;?>
		</tbody>
