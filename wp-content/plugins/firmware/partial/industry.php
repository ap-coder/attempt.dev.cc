...
?>
<div class="wrap">
	<h2><?php esc_html_e( 'Manage Industry Firmware' ); ?></h2>
	<hr>
	...
	jQuery(document).ready(function($){
		...
		$('.btn.btn-select').on('click', function(){
			...
			$('#selected-products').append('<li>\
				<div class="left" style="padding-right: 5px;"><span><i class="fa fa-bars"></i></span></div><div class="none">'+label+'<input type="hidden" name="documents[]" value="'+firmware_id+'" /><span class="btn btn-unselect"><i class="fa fa-minus"></i></span></div></li>')
		});
