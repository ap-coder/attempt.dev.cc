...
<div class="wrap">
	<h2><?php esc_html_e( 'Add Firmware' ); ?></h2>
	<hr>

	<form method="POST" action="<?php echo fwroute('file/upload'); ?>"  enctype="multipart/form-data">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="name" id="name" value="<?php echo isset($doc) && issset($doc->name) ? $doc->name :''; ?>">
					...
					<tr>
						...
						<td>
							<textarea name="sdesc" id="sdesc" cols="30" rows="10"><?php echo isset($doc) && issset($doc->sdesc) ? $doc->sdesc :''; ?></textarea>
						</td>
